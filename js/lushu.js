...
(function() {
     ...
     * @constructor
         * @param {Map} map Baidu map的实例对�?.
         * @param {Array} path 构成路线的point的数�?.
         * @param {Json Object} opts 可选的输入参数，非必填项。可输入选项包括�?<br />
         * {<br />"<b>landmarkPois</b>" : {Array} 要在覆盖物移动过程中，显示的特殊点。格式如�?:landmarkPois:[<br />
    ...
    LuShu.prototype.start = function() {
        ...
        if (me.i && me.i < len - 1) {
            ...
            if (!me._fromPause) {
	            ...
	            //并且此过程中，没有按stop按钮
	            //防止先stop，再pause，然后连续不停的start的异�?
	            me._moveNext(++me.i);
            }
        }else {
            //第一次点击开始，或者点了stop之后点开�?
            me._addMarker();
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _getDistance: function(pxA, pxB) {
          ...
          //目标点的  当前的步�?,position,总的步长,动画效果,回调
        /**
         * 移动小车
         * @param {Number} poi 当前的步�?.
     ...
     * @param {String} html overlay中要显示的东�?.
     * @return 无返回�?.
     */
